...
const Upload = ({ onChange, uploaded, avatar, reset }) => {
  ...
  return (
    <>
      {uploaded ? (
        <>
          <div className="dashed flex cursor-pointer flex-col items-center gap-4 rounded-lg bg-neutral700 bg-opacity-30 p-6 backdrop-blur-sm transition-colors duration-300 ease-in-out hover:bg-opacity-60 focus:bg-opacity-30 focus:outline focus:outline-1 focus:outline-offset-3 focus:outline-neutral300">
            <img
