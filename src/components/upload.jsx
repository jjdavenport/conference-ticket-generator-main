  ...
  return (
    <>
      <label className="flex w-full flex-col gap-2">
        Upload Avatar
        <button className="focus:outline-offset-3 group flex cursor-pointer flex-col items-center gap-2 rounded-lg border border-dashed border-neutral300 bg-neutral700 bg-opacity-40 p-6 backdrop-blur-sm transition-colors duration-300 ease-in-out hover:bg-opacity-100 focus:bg-opacity-40 focus:outline focus:outline-1 focus:outline-neutral300">
          <img
